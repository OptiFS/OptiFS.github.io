...
Now I'm going to try and implement it in the filesystem.
    ...
    },
    {
        ...
        date: "Feb 23 2024",
        blurb: "Documentation and documentation and documentation and documentation and doc...",
        category: "Brainstorming",
        author: "Niall Ryan",
        imageUrl: "niall.jpg",
        content: "Submission day!<br><br>We're really happy with how we our project has ended up!<br><br>We've spent the last few days to work on integrating more unit testing, fixing bugs, documentation and then finally recording the video.<br><br>Our documentation is up to scratch and extensive, both the user manual and the technical specification. Our CI/CD testing is extensive, and most importantly our project works.<br><br>There were many doubts, specifically to do with deduplication and NFS, but we got both working in the end!<br><br>There are a few bugs, but as we're allowed to work on these up until the date of the demo, we'll try hard to get it as good as we can until then, but this was the most ambitious project, atleast I, have ever undertaken. Building a filesystem is absolutely no joke, especially when you have to take into account de-duplication and networking aspects. But we're more than happy to have a functional piece of software by the end of it!",
    },
    {
        title: "Sysadmin Only In Root!",
        date: "Feb 14 2024",
        blurb: "Preventing nefarious activities in the root directory...",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Due to the nature of our system, we decided that it would be the smart idea for only a sysadmin to have access to anything in the root directory. I then decided to implement this functionality by making a checker function to see if we're in the root directory of the filesystem and one to check if the user is the sysadmin.<br><br> Once implemented, I placed this function into all operations that a person could do in root that involve creating or removing a file or directory: <strong>MKDIR, RMDIR, CREATE, UNLINK, MKNOD</strong>.<br><br>After trying to implement this for renaming, I realised that we would have to check if the file/directory that the user is trying to rename is in root, and if the place they are trying to rename it to is also in root. This proved to be slightly challenging, and I just got stuck.<br><br> Happy Valentine's Day to me I guess!",
    },
    {
        title: "Sometimes It's Better To Just Walk Away...",
        date: "Feb 15 2024",
        blurb: "Working myself into a circle again and again :(",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Coming back to OptiFS with a fresh head the next day really helped in coming up with my solution to locking off renaming to everyone but the sysadmin in root. I realised that I was overcomplicating everything and could just design another function to take in the new parent directory of the file. So I implemented this function which checks if the user is allowed in both locations (as the function says). I then implemented this function in renaming and in linking of files.<br><br> Finally I have finished all the sysadmin checks for operations in the system!",
    },
    {
        title: "More Sysadmin Work!",
        date: "Feb 16 2024",
        blurb: "Sysadmin this, sysadmin that.",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Today I wanted to make sure that all of our sysadmin functionalities were in the same place before going any further, so I moved all of the functions into a file called <strong>sysadmin.go<strong>.<br><br> After moving everything to the same place, I began working on letting the current sysadmin change who the sysadmin of the system is by running a flag on startup.",
    },
    {
        title: "'And Where Would You Like Your Data Stored?'",
        date: "Feb 18 2024",
        blurb: "Let's let them decide!",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "One thing that we realised was missing from our filesystem was properly saving the persistent stores of data. As it was, we were just saving it in the source code. Obviously, this isn;t feasible as when OptiFS is released, the user will not have access to the source code. I came up with the idea of having a default location for the data to be saved, in case the sysadmin doesn’t specify where they wish to save the data.<br><br> If the sysadmin does not specify the location of the saved data, then it will be saved in a directory called <i>”save”</i>, in the same location as the underlying filesystem.",
    },
    {
        title: "Attempting To Fix Our Bugs!",
        date: "Feb 19 2024",
        blurb: "Which apparently don't exist???",
        category: "Debugging",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Today I decided to do some debugging after finalising all the sysasdmin functionality. We had been having an issue where the temporary files that are created by editors like vim and IDE’s like vscode were accidentally being stored in our filesystem instead of being deleted. However, after trying for an hour I couldn’t recreate the bug! Somehow, it was fixed with all of the other features we were implementing!!<br><br> Another issue that we had been noticing was that whenever we had an empty file in our filesystem, all of the permissions were set to <strong>---------</strong> and also some strange log errorwhen trying to ls: <strong>ls: hello: Input/output error”</strong>. At first I thought that it was an error with node instantiation, until I discussed with Niall and discovered that he had some dummy code in when he was testing his custom permissions, that stated that if a file was empty, we should just ignore it! Problem solved!",
    },
    {
        title: "My First Stab At Unit Testing",
        date: "Feb 20 2024",
        blurb: "Who knew it was so easy to do unit testing with Go?",
        category: "Testing",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "It was finally time for me to start implementing some unit testing!! Niall had been working on some unit testing for the metadata package, with Go’s built in testing library, so he showed me how to run my own tests and simulate the testing environment. After this I was set up and ready to start testing the permissions package! I implementest tests on permissions and sysadmin.<br><br> When I was trying to test the sysadmin info, I found out that you can make your own versions of structs to test with fake information.<br><br> Finally, I pushed my testing, and then noticed that the pipeline was failing! After some research, I found that using fatalf in my functions actually caused my tests to fail, as they were being exited when i tested invalid values!!",
    },
    {
        title: "Documentation Time!",
        date: "Feb 21 2024",
        blurb: "Time to make some beautiful diagrams!",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Today was all about documentation, as the deadline was creeping closer and closer. I picked up where I left off on the technical specification, by making a package diagram of all of our built in packages and how they communicate with each other. I also wrote tha packages section in the documentation, including built in go libraries and external libraries used in the project.<br><br> I then created a use case diagram for writing a file, to make our activity diagrams a bit easier to deal with when we got to them.<br><br> Finally, I documented some of the problems that I encountered throughout the project.",
    },
    {
        title: "Documentation Done, The Final Stretch...",
        date: "Feb 22 2024",
        blurb: "Polishing off all our documents!",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "I did some formatting of the technical manual to make sure that everything was all perfect for the submission date tomorrow. I added a table of contents to the top of the document, which is actually a substantial task due to it being in markdown. I had to make sure that all the actual items on the table of contents were clickable and navigated to that section of the document.<br><br> I then took it upon myself to handle the user manual, as Niall polished off some final bugs in the system and kinks in the documentation. Since the user of our system is mainly the sysadmin, as the actual users of the filesystem never actually know that OptiFS is there, the user manual proved to be a simple task to do. It was basically what we had been doing to run it every single day that we were producing it!!<br><br>",
    },
    {
        title: "D-Day!",
        date: "Feb 23 2024",
        blurb: "The final sprint before submission!",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Submission day!! We basically worked on our video the whole day, as we had to record multiple different perspectives and edit them all together, as well as a voiceover. Not a very interesting blog today, but glad to say that the main slog of the project is over!!! Woo!!!",
    },
    {
        title: "Birth of The OptiFSFFile",
        date: "Jan 19 2024",
        blurb: "Introduction to concurrency!",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "Now we needed to move onto handling of files, as we cannot implement everything at the node level. So I created the struct to hold the information for an OptiFSFile, and a function that handles the instantiation of these structures. I also implemented reading of a file from its filehandle. All operations on files require locks, so that they are concurrent.",
    },
    {
        title: "Furthering the development of the OptiFSFile",
        date: "Jan 21 2024",
        blurb: "Getting attributes, locks and releasing files.",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "I continued on today with the file operations, again all concurrent. I started with getting the attributes of a file, as most other operations that the filesystem needs to work properly rely on accessing the attributes of a file, for example seeing if a person has permission to write to a file. After this, I implemented releasing a file, or <i>closing</i> it, which is probably the term we’re most used to.<br><br> Finally, I wanted to implement a function that got the locks that were put on a file. To do this we had to convert the fuse locks to linux locks to compare them first.",
    },
    {
        title: "More into Locks...",
        date: "Jan 22 2024",
        blurb: "What types of locks are we setting??",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "After implementing the getlock function, I started working on the set lock function. This function gets the lock on the file, and if it can’t get the lock then it fails. I check to see if we are encountering a read lock, a write lock, or are trying to unlock the file. I also worked on the setlkw function, which operates the same sort of way as setlock does, but it simply waits for the lock to be obtainable if it cannot get it at that exact moment.<br><br> Next, while trying to test if these worked, I discovered that we had an issue with using <strong>touch</strong>, as it stated in the logs that our filesystem was “read only” for some reason? After delving further into these logs, we found that a <strong>create</strong> flag was being passed and not being handled by our filesystem! So I went back and added the create function in the node level of the system to fix the issue, and it worked!<br><br> Then I created a setOwner function, that preserves the original creator of the file, to be used later when we’re figuring out the permissions of the system.<br><br> To finish off the day, I implemented a quick hashing function with the BLAKE3 hashing algorithm and added this into the write function, so that whenever a file is written to, we hash the content of it.",
    },
    {
        title: "The Highs and Lows of Go Binaries!",
        date: "Jan 24 2024",
        blurb: "Who knew built in go libraries are so handy?",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "I figured that the best way to have persistent data would be to store all of this information in a hashmap and find some way of porting it in between runs of the system. This is when I came across something called go binaries, or <i>gobs</i>. This is a built in way of encoding and decoding information in Go, and the best part about it? These gobs that are created hold information about the type of structure that was encoded (struct, map, etc.)!! It seemed perfect for what we needed, so I got to work straight away.<br><br> The next roadblock that I encountered was trying to actually relate the hash of the content to a file in our filesystem. I thought about using the file descriptor of the file, however this is changed every time the file is accessed. I also couldn’t get the name of the file to relate, as we are handling deduplication so two files might have two different names. I tried to use global variables to get the inode number of the file, but I encountered an import cycle, so I couldn’t do this either!!<br><br> As a last ditch effort, I tried to make an interface that both the file and node packages followed to pass the node from one to the other, but this failed too.",
    },
    {
        title: "Just Pass it in to The Initialisation, Duh!",
        date: "Jan 25 2024",
        blurb: "Another example of stepping away makes a difference...",
        category: "Production",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "After thinking a bit more about it, I created a function in the node package to get the inode number of the node. Once I had this function implemented, I pass the results of it through when an OptiFSFile is created. Now I have access to the inode number, which doesn’t change!!! I was then able to place both of these into the hashmap to be stored persistently!",
    },
    {
        title: "Issues With Editors",
        date: "Jan 30 2024",
        blurb: "Maybe we should revert back to using nano...",
        category: "Debugging",
        author: "Zoe Collins",
        imageUrl: "zoe.jpg",
        content: "After doing some further debugging on the system and realising there was an issue with multiple entries being added into the hashmap with their inodes as 0, I decided to look further into fixing the problem. I had never come across the issue before as I was just testing by touching and echo-ing into files, but the error arose when using editors like vim. Looking into it, editors like vim and also IDE’s like vscode create temporary files when writes are being made, in case the system shuts off while the file is being written to, or a random error occurs. So whenever the temporary file was being created, it had an inode number of 0, which was overwriting the number stored in the hashmap.<br><br> After a few hours of trying to fix this issue, I couldn’t come up with a solution. However, Niall had the idea of our own custom metadata system, which you can read more about in his blogs!",
    },
]
